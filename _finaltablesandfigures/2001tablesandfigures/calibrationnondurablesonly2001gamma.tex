...
Notes: The model is calibrated at a monthly frequency. The parameter $\gamma$ is calibrated to either 0.3, 0.5, or 0.9, which corresponds to the aggregate MPC in the model. See the text for details. \end{minipage}
