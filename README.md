...
| Figure/Table                                            | Task Directory   |
|---------------------------------------------------------|------------------|
| calibrationnondurablesonly2001gamma.tex                 | model            |
| mpcsgammanondurablesonly2001.tex                        | model            |
| Table_2001_NDcompare.tex                                | psmjregressions  |
| Table_2001_NDcomparerbtonly.tex                         | psmjregressions  |
| bea_all.tex                                             | psmjregressions  |
| Table_2001_NDcompare_wlag.tex                           | psmjregressions  |
| Table_2001_NDcompare_wlagrbtonly.tex                    | psmjregressions  |
| bea_all_longtable.tex                                   | psmjregressions  |
| fig_cy_pres.eps                                         | narrative        |
| fig_cy_pres01.eps                                       | narrative        |
| fig_jpscy_pres01.eps                                    | narrative        |
| fig_rebate_ndisp01.eps                                  | narrative        |
| Real_JPSNondurablesfc_micro_nondurablesonly2001.eps     | model            |
| Real_JPSNondurablesfc_GE_nondurablesonly2001_nolegend.eps| model            |
| SPF_dist_0102_wactual.pdf                               | survey_prof_fore |
| fig_forecasts2001_jpsnondur.eps                           | forecasting      |
