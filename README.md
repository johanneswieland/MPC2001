...
The following table lists which figure is generated by which final task. One can generate one figure at a time by `cd`ing into its task directory and running `make`.

Final Figure / Table | Task Directory 
